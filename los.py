...
def find_key_len(url: str, payload: str,
                 p: str, success_str: str, cook={}, method='get', print_resp=False) -> int:
    left = -1
    right = 32
    while right > left + 1:
        middle = (left + right) // 2
...
def find_binary(url: str, payload: str,
                p: str, m_row: str, left: int, right: int, len_of_key: int, cook={}) -> str:
    '''
     left, right: min and max ascii code of symbol
     m_row: str of success in response
    '''
    result = ''
    num_of_requests = 0
...
def find_pass_over_bits(url: str, payload: dict, len_of_key: int, m_row: str,
                        cook={}, unicode_len_bit=8, method='get', print_resp=False) -> str:
    '''
    m_row: str of success in response
